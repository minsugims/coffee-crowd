...
const LoginPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const API_BASE_URL = import.meta.env.VITE_BUYLOCAL_API_BASE_URL;
    ...
    return (
        <div className="flex items-center justify-center h-[calc(100vh-4rem)] bg-gray-100">
            {loading ? (
                /** Splash Screen */
                <div className="flex flex-col items-center justify-center w-full max-w-sm p-8 bg-white rounded-lg shadow-lg">
                    <div className="w-12 h-12 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"></div>
                    <p className="mt-4 text-lg font-semibold text-gray-800">Logging in...</p>
                </div>
            ) : (
                /** Login Form */
